...
htmlhelp_basename = 'kinomodeldoc'
...
latex_documents = [
    (master_doc, 'kinomodel.tex', 'kinomodel Documentation',
     'kinomodel', 'manual'),
]
...
man_pages = [
    (master_doc, 'kinomodel', 'kinomodel Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kinomodel', 'kinomodel Documentation',
     author, 'kinomodel', 'This is a handy tool to model different kinase conformations with various ligand binding poses.',
     'Miscellaneous'),
]
